    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            const { error } = await supabase.auth.signUp({
                ...
                options: {
                    data: {
                        role: 'subscriber', // Default role for public signups
                    },
                },
            });
            ...
            // Optional: redirect to a "check email" page or stay here
        } catch (error: any) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-gray-900">Human Pulse 시작하기</h1>
                    <p className="text-gray-500 mt-2">계정을 생성하여 감정 여정을 기록하세요.</p>
                </div>
